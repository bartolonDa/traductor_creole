                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: Border.all(
                          color: Colors.white.withOpacity(.3), width: 3),
                    ),
                    child: const Center(
              ...
              child: Column(
                ...
                children: [
                  ...
                  _settingToggle(
                    ...
                    subtitle: _offline ? 'Activo' : 'Desactivado',
                    value: _offline,
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(sub,
                style: TextStyle(
                    fontSize: 11, fontWeight: FontWeight.w600, color: text3)),
          ]),
        ),
        if (showChevron)
          Icon(Icons.chevron_right_rounded, color: text3, size: 20),
      ]),
    );
  }
